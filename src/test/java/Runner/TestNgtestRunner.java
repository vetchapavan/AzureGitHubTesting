...
import junit.textui.TestRunner;
		...
		@CucumberOptions(features="src/test/java/feature/placevalidations.feature",glue="StepDefinitions",monochrome=true,plugin= {"html:target/cucumber.json","com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"})
